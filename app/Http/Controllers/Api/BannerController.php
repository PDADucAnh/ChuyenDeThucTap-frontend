...
class BannerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Admin might want to see all statuses, client only active
        ...
        $banners->transform(function ($banner) {
            $banner->image_url = $banner->image ? (str_starts_with($banner->image, 'http') ? $banner->image : asset('storage/' . $banner->image)) : null;
            return $banner;
        });
